...
public class Querys {
    ...
    public static String GET_ESTUDIANTES = "select ID,ESTUDIANTE.NOM,PAPE,SAPE,TEL,CEL,EMAIL,HORARIO,CICLO,CID,SEDE,BECA,TUTORIA.NOM from ESTUDIANTE,GRUPO,MATRICULA,TUTORIA WHERE ID=EID AND GNUM=NUM AND TCOD=COD GROUP BY ID;";
